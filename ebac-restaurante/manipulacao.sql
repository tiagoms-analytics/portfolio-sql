/*
O exercicio foi realizado as inserçoes dos dados nas tabelas
(funcionarios, clientes, produtos, pedidos, info_produtos)
*/
...
INSERT INTO funcionários (nome, cpf, data_nascimento, endereco, telefone, email, cargo, salário, data_admissao) VALUES
 ...
 INSERT INTO produtos (nome, descricao, preco, categoria) VALUES
  ...
  -- --- INSERÇÕES NA TABELA: info_produtos ---
  ...
  INSERT INTO info_produtos (id_produto, ingredientes, fornecedor) VALUES
   ...
   INSERT INTO pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status_pedidos) VALUES
    ...
    -- Atualizado o funcionário do CPF 444.555.666-77, com o cargo de ‘Garçonete’ e salário de 2700.
    UPDATE funcionarios SET cargo =  'Garçonete', salario = 2700 WHERE id_funcionario = 4; 
    
    -- Atualizado todos os pedidos com dados menores que '2024-07-06' para status como 'Concluído'.
    -- Precisa desativar o modo de segurança (SET SQL_SAFE_UPDATES = 0), cuidado com essa operação.
    UPDATE pedidos SET status_pedidos = 'Concluído'WHERE data_pedido < '2024-07-06';
    
    SET SQL_SAFE_UPDATES = 0; -- reativar o SQL_SAFE_UPDATES
    
    SET SQL_SAFE_UPDATES = 1; -- Boa prática: reativar o modo de segurança
    
    -- Remoção do funcionário CPF 222.333.444-55
    DELETE FROM funcionários WHERE id_funcionario = 2;
